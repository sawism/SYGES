            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto py-4 py-md-0">
                ...
                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active">
                  <a class="btn-primary" href="Affichage_recette.php" role="button" aria-haspopup="true" aria-expanded="false">Recettes</a>
                </li>
                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 ">
		...
		<div class="col-md-12 mt-4">
			...
			<div class="card">
				...
				<h3> SYSTEME DE GESTION DE LA TRESORERIE 
					<a href="ajout_rec.php" class="btn btn-primary float-end"> Ajouter Recette</a>
...
$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
							$query = "SELECT * FROM syges.recette";
							...
							if ($result) 
							{
								foreach ($result as $row) {
									...
									<tr>
										...
										<td><?= $row->date ;   ?></td>
										<td><?= $row->montant ;   ?></td>
										<td> <form action="" method="POST"><button type="submit" class="btn btn-primary"><a class="btn btn-primary" href="Modifier_recette.php?id_recette=<?=$row->id_recette ;?>">  Modifier </a> </button>    </form></td>
										<td> <form action="code.php" method="POST">
											<button type="submit" class="btn btn-danger" name="Supprimer" value="<?=$row->id_recette;?>">Supprimer</button>
											</form>
